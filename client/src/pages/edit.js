        ...
        uploadTask.on(
          ...
          async () => {
            try {
              ...
              console.error(
                "Error getting profile picture download URL:",
                error
              );
            }
          }
    ...
    <div class="md:p-1 lg:p-3 custom-scrollbar">
      <div class=" w-full flex flex-col items-center justify-center ">
        <img
          ...
          alt="ssehhe"
          class=" h-44 md:h-64 lg:h-96 w-[100%] md:m-1 lg:m-3 block"
        ></img>
        ...
        <img
          ...
          alt="ehhe"
          class="relative  h-[25vw] md:h-[20vw] md:w-[20vw] lg:h-[15vw] lg:w-[15vw] w-[25vw] border-2 top-[-6vw] border-white shadow-md rounded-full "
        ></img>
        <h1 class="mt-[-6vw] font-bold text-sm md:text-xl">
          {currentUser.username}
        </h1>
        <h1 className="text-sm">{currentUser.desc}</h1>
      </div>
      <form
        class="flex flex-wrap h-full w-full justify-center items-center border gap-x-10 gap-y-4 md:gap-y-6 lg:gap-y-9 py-3 md:py-6 lg:py-9 box-shadow mt-4"
        onSubmit={Edit}
      >
        <div class="w-2/5  md:text-lg font-thin">
          Profile Picture :
        ...
        <input
          ...
          class=" h-5 md:h-7 lg:h-10 p-3 text-sm  w-2/5 outline-none border border-gray-400 rounded-md"
        ...
        <input
          ...
          class=" h-5 md:h-7 lg:h-10 text-sm p-3 w-2/5 outline-none border border-gray-400 rounded-md"
          onChange={serverInput}
        ></input>
        <input
          id="desc"
        ...
        <button
          class={` h-5 md:h-7 lg:h-10 flex text-sm justify-center items-center  text-white p-3 w-2/5  rounded-md
            ${
              per !== null && per < 100
